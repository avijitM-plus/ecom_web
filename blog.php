...
<body class="font-sans bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 transition duration-300">
    ...
    <main class="container mx-auto px-4 py-8">
        <h1 class="text-4xl font-bold mb-2 text-center">Latest News</h1>
        <p class="text-gray-500 text-center mb-12">Updates from the world of Robotics & IoT</p>
